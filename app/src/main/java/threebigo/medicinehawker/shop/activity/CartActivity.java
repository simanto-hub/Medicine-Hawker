...
import threebigo.medicinehawker.shop.adapter.CartListAdapter;
...
import threebigo.medicinehawker.shop.model.Product;
        ...
        lyttotal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (session.isUserLoggedIn()) {
                    startActivity(new Intent(CartActivity.this, UploadPrescription.class));
                } else {
