 ...
 * @param size
 * @param drawableWidth
 * @return After any change described in the comments for fitImageToView, the matrix needs to be
 ...
 * @return Interpolate the current targeted zoom and get the delta
 * from the current zoom.
 * @param t
 * @return This function will transform the coordinates in the touch event to the coordinate
